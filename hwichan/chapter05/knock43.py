...
def main():
    for i, chunks in enumerate(make_list('neko.txt.cabocha'), 1):  # chunks : Chunkのインスタンスが1文ずつ入った配列が格納
        if i == 10:
            break
        ...
        for chunk in chunks:
            ...
            # 現在の文節に名詞が含まれていて、係り先(chunk.dst)に動詞が含まれている場合
