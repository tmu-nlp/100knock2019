...
def index():
        if request.method == 'POST':
            ...
            return render_template('/users/hongfeiwang/100knock2019/wanghongfei/chapter07/result.html', artists=results) 
        else:
            return render_template('/users/hongfeiwang/100knock2019/wanghongfei/chapter07/search.html') 
